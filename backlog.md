...
- Small releases:
  - `SEC-HARD-001A`: headers globais, CSP compatível, contrato da origem Supabase e validação real em Preview — `IN_PROGRESS`, com Dia 2 concluído em RED controlado (12 casos: 11 falhas planejadas e 1 fronteira verde).
...
- Status: IN_PROGRESS para `SEC-HARD-001A` — `TEST_STRATEGY_READY`; próximo passo: Dia 3
