...
- Small releases:
  - `SEC-HARD-001A`: headers globais, CSP compatível, contrato da origem Supabase e validação real em Preview — `IN_PROGRESS`, com Dia 3 concluído em GREEN (85 suítes/494 testes, lint, type-check e build verdes).
...
- Status: IN_PROGRESS para `SEC-HARD-001A` — `IMPLEMENTATION_IN_PROGRESS`; próximo passo: Dia 4 e validação em Preview
