...
- Fase recomendada: `003A`, `003B` e `003C1` concluídas e mescladas; `003C2` está `SPEC_READY` e segue para o Dia 2.
...
- Status: IN_PROGRESS — `UX-CHART-003A`, `003B` e `003C1` estão mescladas; `003C2` está `SPEC_READY`; `003C3` permanece planejada.
...
- Status: IN_PROGRESS — `003C1` foi `RELEASED` pela PR `#30` no commit `a96b564`; `003C2` está `SPEC_READY` e granularidades trimestral/anual seguem bloqueadas no adapter; `003C3` permanece pendente.
...
- Status: SPEC_READY — Dia 1 aprovado; próximo comando válido é o Dia 2.
